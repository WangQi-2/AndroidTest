 ...
 */
public class ViewCube3Activity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_cube3);
        setUpViews();
    }
    ...
    private void setUpViews() {
        ...
        viewGroup1.setBackgroundColor(0xffdddddd);
        viewGroup2.setBackgroundColor(0xffdddddd);
        viewGroup3.setBackgroundColor(0xffdddddd);
        viewGroup4.setBackgroundColor(0xffdddddd);
        viewGroup5.setBackgroundColor(0xffdddddd);
        viewGroup6.setBackgroundColor(0xffdddddd);
    ...
    private Collection<Animator> generateDispear2RightTwoAnimator(View v) {
        ...
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(v, View.ROTATION_Y, 0, -DEGREE_SMALL);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(v, View.SCALE_X, DISPEAR_SCALE_RATE, 0.79f, 1);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, DISPEAR_SCALE_RATE, 0.79f, 1);
        animators.add(translationX);
        animators.add(rotationY);
    ...
    private Collection<Animator> generateRightTwo2DispearAnimator(View v) {
        ...
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(v, View.ROTATION_Y, -DEGREE_SMALL, 0);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(v, View.SCALE_X, 1, 0.80f, DISPEAR_SCALE_RATE);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, 1, 0.80f, DISPEAR_SCALE_RATE);
        animators.add(scaleX);
        animators.add(scaleY);
        animators.add(translationX);
        animators.add(rotationY);
    ...
    private Collection<Animator> generateDispear2RightThreeAnimator(View v) {
        List<Animator> animators = new ArrayList<>();
        v.setPivotX(0);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(v, View.TRANSLATION_X, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH);
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(v, View.ROTATION_Y, 0, 5, DEGREE_BIG);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, 1, 1.4f, 1);
        animators.add(translationX);
        animators.add(rotationY);
        animators.add(scaleY);
        return animators;
    ...
    private Collection<Animator> generateRightThree2DispearAnimator(View v) {
        List<Animator> animators = new ArrayList<>();
        v.setPivotX(0);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(v, View.TRANSLATION_X, VIEW_WIDTH, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f);
        ObjectAnimator rotationY = ObjectAnimator.ofFloat(v, View.ROTATION_Y, DEGREE_BIG, 5, 0);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, 1, 1.4f, 1);
        animators.add(translationX);
        animators.add(rotationY);
        animators.add(scaleY);
    ...
    private Collection<Animator> generateDispear2RightFourAnimator(View v) {
        List<Animator> animators = new ArrayList<>();
        v.setPivotX(0);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(v, View.TRANSLATION_X, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * VIEW4_MOVING_RATE);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(v, View.SCALE_X, 1, DISPEAR_SCALE_RATE);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, 1, DISPEAR_SCALE_RATE);
        animators.add(translationX);
        animators.add(scaleX);
    ...
    private Collection<Animator> generateDispear2LeftFourAnimator(View v) {
        List<Animator> animators = new ArrayList<>();
        v.setPivotX(0);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(v, View.TRANSLATION_X, -VIEW_WIDTH * 1.5f, -VIEW_WIDTH * 0.41f);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(v, View.SCALE_X, 1, DISPEAR_SCALE_RATE);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, 1, DISPEAR_SCALE_RATE);
        animators.add(translationX);
        animators.add(scaleX);
    ...
    private Collection<Animator> generateRightFour2DispearAnimator(View v) {
        List<Animator> animators = new ArrayList<>();
        v.setPivotX(0);
        ObjectAnimator translationX = ObjectAnimator.ofFloat(v, View.TRANSLATION_X, VIEW_WIDTH * VIEW4_MOVING_RATE, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f, VIEW_WIDTH * 1.5f);
        ObjectAnimator scaleX = ObjectAnimator.ofFloat(v, View.SCALE_X, DISPEAR_SCALE_RATE, 1);
        ObjectAnimator scaleY = ObjectAnimator.ofFloat(v, View.SCALE_Y, DISPEAR_SCALE_RATE, 1);
        animators.add(translationX);
        animators.add(scaleX);
    ...
    public static class Four2ThreeInterpolator implements Interpolator {
        @Override
